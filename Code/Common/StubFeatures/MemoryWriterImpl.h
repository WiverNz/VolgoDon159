...
MemoryWriter& MemoryWriter::operator<<(yasli::i32 value)
{
    char buffer[12];
...
MemoryWriter& MemoryWriter::operator<<(yasli::u32 value)
{
    char buffer[12];
...
MemoryWriter& MemoryWriter::operator<<(yasli::i64 value)
{
    char buffer[24];
#ifdef _MSC_VER
...
MemoryWriter& MemoryWriter::operator<<(yasli::u64 value)
{
    char buffer[24];
#ifdef _MSC_VER
...
MemoryWriter& MemoryWriter::operator<<(yasli::u8 value)
{
    char buffer[12];
    sprintf(buffer, "%i", int(value));
    return operator<<((const char*)buffer);
...
MemoryWriter& MemoryWriter::operator<<(yasli::i8 value)
{
    char buffer[12];
    sprintf(buffer, "%i", int(value));
    return operator<<((const char*)buffer);
