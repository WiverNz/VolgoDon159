...
namespace YasliFix{
	...
	class MemoryWriter : public yasli::RefCounter {
public:
	...
	YASLI_INLINE MemoryWriter& operator<<(yasli::i8 value);
	YASLI_INLINE MemoryWriter& operator<<(yasli::u8 value);
	YASLI_INLINE MemoryWriter& operator<<(yasli::i32 value);
	YASLI_INLINE MemoryWriter& operator<<(yasli::u32 value);
	YASLI_INLINE MemoryWriter& operator<<(yasli::i64 value);
	YASLI_INLINE MemoryWriter& operator<<(yasli::u64 value);
